...
build/Parse.o: lib/Parse.cpp | build/
	$(cc) -Wall -pedantic -g -c lib/Parse.cpp -I ./lib -o build/Parse.o

build/menu.o: lib/menu.cpp | build/
	$(cc) -Wall -pedantic -g -c lib/menu.cpp -I ./lib -o build/menu.o

build/main.o: test/main.cpp | build/
	$(cc) -Wall -pedantic -g -c test/main.cpp -I ./lib -o build/main.o

build/test: build/main.o build/Poste.o build/Entreprise.o build/Personne.o build/Chomeur.o build/Employer.o build/Parse.o build/menu.o | build/
	$(cc) -o build/test build/Poste.o build/Entreprise.o build/Personne.o build/Chomeur.o build/Employer.o build/Parse.o build/menu.o build/main.o
